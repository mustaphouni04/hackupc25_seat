...
const FULL_IMAGE = "/images/steering.jpeg";
        ...
        {currentPage === 1 ? (
          <>
            ...
            <button
              ...
              className="bg-gray-300 hover:bg-gray-400 text-black font-semibold py-2 px-6 rounded-lg shadow-md transition duration-300"
            >
              Back
            </button>
              <button
